...
export interface paths {
    ...
    "/analytics/summary": {
        ...
        /** Order funnel totals from saga events (analytics-service) */
    ...
    "/analytics/orders-by-day": {
        ...
        /** Daily status counts for the last N days */
        get: operations["analyticsOrdersByDay"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        AnalyticsOrdersByDay: {
            days: number;
            items: components["schemas"]["AnalyticsDayStatusCount"][];
        };
        AnalyticsDayStatusCount: {
            /** Format: date */
            day: string;
            status: string;
            count: number;
    ...
    analyticsOrdersByDay: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AnalyticsOrdersByDay"];
                };
            };
        };
    };
